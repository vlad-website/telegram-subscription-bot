...
async def show_tariffs(message: Message):
    ...
    text = (
        "Ты не просто оформляешь подписку, ты входишь в закрытый женский круг, где тебя поймут с полуслова\n\n"
        "Каждый месяц в клубе тебя ждут:\n"
        "- тренировки, рецепты, лайфхаки \n"
        "- подкасты, советы, мои фишечки и секреты \n"
        "- закрытый чат для общения и поддержки\n"
        "- практики, подсказки, ритуалы и закрытые материалы\n"
        "- и пространство, где можно быть собой.\n"
    )
